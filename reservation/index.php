        ...
        <div class="lg:w-2/6 md:w-1/2 bg-gray-200 rounded-lg p-8 flex flex-col md:mx-auto mt-10 md:mt-0">
          ...
          <?php
            if(isset($_POST['submit'])){
                if($_POST['nama']==''){
                    echo "<p class='texl-2xl text-red-500 pb-3 font-bold'>Nama tidak boleh kosong!</p>";
                }
                elseif($_POST['nomor']==0){
                    echo "<p class='texl-2xl text-red-500 pb-3 font-bold'>Nomor tidak boleh kosong!</p>";
                }
                elseif($_POST['alamat']==''){
                    echo "<p class='texl-2xl text-red-500 pb-3 font-bold'>Alamat tidak boleh kosong!</p>";
                }
                else{
